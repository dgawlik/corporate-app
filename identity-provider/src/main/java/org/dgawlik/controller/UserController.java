...
public class UserController {
    ...
    public String createUser(@RequestBody Map<String, String> body) {
        store.add(body.get("firstName"), body.get("lastName"));
        return "ok";
    }

    @PostMapping("/api/user/delete")
    @ResponseBody
    public String deleteUser(@RequestBody Map<String, String> body) {
        store.delete(body.get("firstName"), body.get("lastName"));
        return "ok";
    }
}
